...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void JpegInitSource8(j_decompress_ptr dinfo) {}

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
boolean JpegFillInputBuffer8(j_decompress_ptr dinfo) {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void JpegSkipInputData8(j_decompress_ptr dinfo, long nBytes) {
  auto &src = *dinfo->src;
  if (nBytes > 0) {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void JpegTermSource8(j_decompress_ptr dinfo) {}

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void ErrorExit8(j_common_ptr dinfo) {
  char buf[JMSG_LENGTH_MAX];
  (*dinfo->err->format_message)(dinfo, buf);
  ThrowNativePixelDecoderException("JpegDecoder8::ErrorExit8::" + string(buf));
}

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void OutputMessage8(j_common_ptr dinfo) {
  char buf[JMSG_LENGTH_MAX];
  (*dinfo->err->format_message)(dinfo, buf);
  OutputNativePixelDecoderMessage("JpegDecoder8::OutputMessage8::" +
                                  string(buf));
}

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void EmitMessage8(j_common_ptr dinfo, int messageLevel) {
  char buf[JMSG_LENGTH_MAX];
  (*dinfo->err->format_message)(dinfo, buf);
  OutputNativePixelDecoderMessage("JpegDecoder8::EmitMessage8::" + string(buf));
}

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void DecodeJpeg8(DecoderContext *ctx, DecoderParameters *params) {
  jpeg_error_mgr jerr;

  jpeg_decompress_struct dinfo;
  dinfo.err = jpeg_std_error(&jerr);
  dinfo.err->error_exit = ErrorExit8;
  dinfo.err->output_message = OutputMessage8;
  dinfo.err->emit_message = EmitMessage8;
  jpeg_create_decompress(&dinfo);

  jpeg_source_mgr src;
  memset(&src, 0, sizeof(src));

  src.init_source = JpegInitSource8;
  src.fill_input_buffer = JpegFillInputBuffer8;
  src.skip_input_data = JpegSkipInputData8;
  src.resync_to_restart = jpeg_resync_to_restart;
  src.term_source = JpegTermSource8;
